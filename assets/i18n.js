(function (global) {
  ...
  var ZH = {
    ...
    "title.island.privacy": "隐私政策 — Here Island",
    ...
    "meta.island": "Here Island — 正在播放的音乐显示在 Mac 灵动岛里。",
    "meta.island.privacy": "Here Island 隐私政策 — Locusable Studio。",
    ...
    "home.wallpaper.tag.mac": "Mac",
    "home.sidefy.subhead": "把今天的日程放在屏幕边缘。",
    "home.island.subhead": "正在播放的音乐显示在 Mac 灵动岛里。",
    ...
    "about.moreBody": "Mac 灵动岛、屏幕边缘、壁纸和图标之间，这些平时没人注意的地方，往往最适合放一个小工具。我们就做这类原生应用。",

    "wallpaper.subhead": "把你在意的地点做成地图壁纸。",
    "wallpaper.previews": "壁纸预览",
    "wallpaper.macTitle": "Mac 上的动态壁纸",
    "wallpaper.macSubhead": "同样的地点和配色，在桌面上实时渲染。",
    ...
    "wallpaper.faq.a3": "运行 iOS 26 或更高版本的 iPhone 或 iPad，或运行 macOS 26 或更高版本的 Mac。",
    "wallpaper.faq.q4": "Here Wallpaper 会收集个人数据吗？",
    "wallpaper.faq.a4": "没有分析、广告或追踪。只有你点定位时才会用到位置。",
    "wallpaper.faq.q5": "Pro 包含什么？",
    "wallpaper.faq.a5": "精选和自定义主题、字体、App 图标、额外地图图层，以及隐藏导出版权。",
    "wallpaper.faq.q6": "Mac 上能用吗？",
    "wallpaper.faq.a6": "可以。独立 Mac 应用已上架，一份 Pro 订阅覆盖 iPhone、iPad 和 Mac。",
    ...
    "island.brewSubhead": "用 Homebrew 安装，先信任安装包。",
