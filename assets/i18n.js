(function (global) {
  ...
  var ZH = {
    ...
    "wallpaper.faq.a3": "iPhone 或 iPad。Mac 应用上线后，需要 macOS 26 或更高版本。",
    ...
    "wallpaper.faq.a5": "iCloud 同步、快捷指令、更多主题和字体、更多地图图层，还可以隐藏导出水印。",
    ...
    "hackerba.faq.a4": "不会。它只重排页面，数据不会离开浏览器。",
    ...
    "links.faq.q3": "运行条件？",
    "links.faq.a3": "运行 iOS 26 的 iPhone 或 iPad，再加上带 API 令牌的 linkding 服务器。",
