(function (global) {
  ...
  var ZH = {
    ...
    "about.wallpaper": "你的地点。你的壁纸。",
    "about.sidefy": "你的日程。沿屏边缘。",
    "about.island": "音乐。栖于刘海。",
    "about.trmnl": "你的屏。浮于桌面。",
    "about.hackerba": "HN。化身论坛。",
    "about.links": "即将推出 — 你的书签。原生 iPhone。",
    ...
    "wallpaper.faq.q2": "Pro 包含什么？",
    "wallpaper.faq.a2": "iCloud 同步。快捷指令。更多主题与字体。更多图层。可隐藏水印。",
    "wallpaper.faq.q3": "地图数据从哪来？",
    "wallpaper.faq.a3": "OpenStreetMap 与开放项目。MapLibre 渲染。",
    "wallpaper.macSoon": "独立 Mac 应用。即将上线。",
    "wallpaper.faq.q4": "Mac 上能用吗？",
    "wallpaper.faq.a4": "即将支持。独立 Mac 应用在路上。一份订阅，覆盖三端。",
    ...
    "sidefy.faq.a1": "Mac App Store 一次性买断。无需订阅。",
    "sidefy.faq.q2": "Here Sidefy 能对接哪些服务？",
    "sidefy.faq.a2": "日历。提醒。RSS 与 Atom。GitHub 动态。插件事件。尽收边缘。",
    "sidefy.faq.q3": "Here Sidefy 会收集个人数据吗？",
    "sidefy.faq.a3": "不会。数据存于 iCloud。应用不收集。",
    ...
    "island.faq.q1": "Here Island 免费开源吗？",
    "island.faq.a1": "免费且开源。GPL v3。",
    "island.faq.q2": "它能做什么？",
    ...
    "trmnl.faqTitle": "常见问题",
    "trmnl.faq.q1": "Here TRMNL 现在能用吗？",
    "trmnl.faq.a1": "可以。GitHub 下载最新版本。",
    "trmnl.faq.q2": "免费吗？开源吗？",
    "trmnl.faq.a2": "免费下载。源码开源。",
    "trmnl.faq.q3": "它做什么？",
    "trmnl.faq.a3": "菜单栏应用。BYOS 画面镜像桌面。壁纸与图标之间。点击穿透。",
    "trmnl.faq.q4": "运行条件？",
    "trmnl.faq.a4": "macOS 26.0 或更高。兼容 LaraPaper 的 base URL、设备 ID 与令牌。",
    ...
    "hackerba.faq.q1": "Here HackerBa 免费开源吗？",
    "hackerba.faq.a1": "免费且开源。MIT 许可。",
    "hackerba.faq.q2": "它能做什么？",
    "hackerba.faq.a2": "Chrome 扩展。HN 变身贴吧式论坛。内容与账号不变。",
    "hackerba.faq.q3": "如何安装？",
    "hackerba.faq.a3": "Chrome 扩展页。加载未打包扩展。打开任意 HN 页面。",
