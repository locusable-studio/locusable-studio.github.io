(function (global) {
  ...
  var ZH = {
    ...
    "meta.links": "Here Links — 自托管 linkding 的原生 iOS 客户端。",
    ...
    "home.wallpaper.subhead": "把你在意的地方，变成地图锁屏。",
    ...
    "home.links.subhead": "你的自托管 linkding，原生 iOS 体验。",
    ...
    "about.wallpaper": "把你在意的地方，变成地图锁屏。",
    ...
    "about.links": "即将推出 — 你的自托管 linkding，原生 iOS 体验。",

    "wallpaper.subhead": "把你在意的地方，变成地图锁屏。",
    "wallpaper.previews": "壁纸预览",
    "wallpaper.placeTitle": "地点与排版",
    "wallpaper.placeSubhead": "选一座城市，或一个你在意的地点，作为你的锁屏；再调整字体与构图，贴合你的手机屏幕。",
    ...
    "links.subhead": "你的自托管 linkding，原生 iOS 体验。",
    "links.previews": "应用预览",
